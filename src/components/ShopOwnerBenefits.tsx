      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <div className="inline-block px-4 py-2 bg-[#582e50]/5 rounded-full mb-6">
            <span className="text-sm text-[#582e50]/70">For Shop Owners</span>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative order-2 lg:order-1">
            <div className="relative rounded-3xl overflow-hidden shadow-2xl shadow-[#582e50]/20 border border-[#582e50]/10">
              <ImageWithFallback 
              ...
              />
              {/* Overlay card */}
              <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md rounded-2xl p-6 border border-[#582e50]/10">
                <div className="flex items-center justify-between">
                  <div>
                    <div className="text-3xl text-[#432758] mb-1">2.5x</div>
                    <div className="text-sm text-[#582e50]/70">Average sales increase</div>
                  </div>
                  <div className="h-12 w-px bg-[#582e50]/10" />
                  <div>
                    <div className="text-3xl text-[#432758] mb-1">24hrs</div>
                    <div className="text-sm text-[#582e50]/70">Fast settlement</div>
                  </div>
                  <div className="h-12 w-px bg-[#582e50]/10" />
                  <div>
                    <div className="text-3xl text-[#432758] mb-1">5%</div>
                    <div className="text-sm text-[#582e50]/70">Low commission</div>
                  </div>
                </div>
              </div>
            </div>
            {/* Decorative blur */}
            <div className="absolute -bottom-10 -right-10 w-64 h-64 bg-[#d35e37]/20 rounded-full blur-3xl -z-10" />
          </div>
          ...
          <div className="order-1 lg:order-2 space-y-6">
            {benefits.map((benefit, index) => (
              <div 
                key={index}
                className="group bg-gradient-to-r from-[#ededec] to-white rounded-2xl p-6 border border-[#582e50]/5 hover:border-[#d35e37]/30 transition-all duration-300 hover:shadow-lg hover:shadow-[#d35e37]/10"
              >
                <div className="flex items-start gap-4">
                  <div className="w-12 h-12 bg-[#582e50] rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300 shadow-md shadow-[#582e50]/20">
            ...
            {/* CTA */}
            <div className="pt-6">
              <button className="group w-full sm:w-auto px-8 py-4 bg-[#582e50] text-white rounded-2xl hover:bg-[#432758] transition-all duration-300 flex items-center justify-center gap-2 shadow-lg shadow-[#582e50]/20 hover:shadow-xl hover:shadow-[#582e50]/30">
                Become a QikCat Partner
                <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
              </button>
              <p className="text-sm text-[#582e50]/70 mt-4">
