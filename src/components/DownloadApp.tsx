...
export function DownloadApp() {
  return (
    <section className="py-24 md:py-32 bg-gradient-to-br from-black to-gray-900 text-white relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-6 border border-white/20">
              <div className="flex flex-col sm:flex-row gap-3">
                <input 
                  ...
                  className="flex-1 px-6 py-4 bg-white text-black rounded-xl placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-white/50"
                />
                <button className="px-6 py-4 bg-white text-black rounded-xl hover:bg-gray-100 transition-all duration-300 shadow-xl whitespace-nowrap">
                  Join Waitlist
                </button>
              </div>
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="relative z-10">
              <div className="w-80 h-[650px] rounded-[3.5rem] bg-gray-900 p-4 shadow-2xl shadow-black/50">
                ...
                {/* Notch */}
                <div className="absolute top-7 left-1/2 -translate-x-1/2 w-28 h-7 bg-gray-900 rounded-full" />
              </div>
            </div>
            ...
            <div className="absolute -bottom-6 -right-6 px-4 py-3 bg-white text-black rounded-xl shadow-xl">
